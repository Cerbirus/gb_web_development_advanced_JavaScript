    ...
    template: `
        <li class="products-item" data-id="2" data-name="Product 2" data-price="20">
            <article class="products-item-article">
                ...
                <button class="products-item-cart-btn" @click="$root.$refs.cart.addProduct(product)">
...
const comp_catalog_products = {
    ...
    mounted() {
        this.$parent.getJson(`${API}/db/products.json`)
            .then(data => {
                for (let el of data) {
            ...
            <section class="products">
                <div class="container ">
                    ...
                    <ul class="products-listing">
                        <comp_products_item v-for="item of cartItems" :key="item.id_product" :img="img" :cart-item="item">
                        </comp_products_item>
                    </ul>
